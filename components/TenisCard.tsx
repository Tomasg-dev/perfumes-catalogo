...
export default function TenisCard({
  ...
  return (
    <div className="group flex flex-col">
      ...
      <div className="pt-4">
        <Link href={`/tenis/${tenis.slug}`} className="block">
          <h3 className="line-clamp-2 font-serif text-lg leading-snug text-[var(--color-ink)] group-hover:text-[var(--color-gold)] transition-colors">
            {tenis.nombre}
          </h3>
        ...
        <div className="mt-2 flex items-center justify-between gap-3">
          <p className="text-sm text-[var(--color-ink)]">{formatPrice(tenis.precio)}</p>
